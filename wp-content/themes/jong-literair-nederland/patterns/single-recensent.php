<?php
/**
 * Title: single-recensent
 * Slug: jong-literair-nederland/single-recensent
 * Inserter: no
 */
?>
...
<!-- wp:column {"width":"25%"} -->
<div class="wp-block-column" style="flex-basis:25%"><!-- wp:query {"queryId":1,"query":{"postType":"post","perPage":10,"pages":1,"order":"desc","orderBy":"date","queryType":"recensent","offset":0,"exclude":[],"inherit":false},"namespace":"ln-query"} -->

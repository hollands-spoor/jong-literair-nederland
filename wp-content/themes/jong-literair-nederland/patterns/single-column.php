...
/**
 * Title: single-column
 * Slug: jong-literair-nederland/single-column
 * Inserter: no
 */
?>
...
<div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:jln/jln-titel /--></div>
<!-- /wp:column -->
...
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"width":"66.66%"} -->
<div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:post-content {"layout":{"type":"default"}} /--></div>
<!-- /wp:column -->

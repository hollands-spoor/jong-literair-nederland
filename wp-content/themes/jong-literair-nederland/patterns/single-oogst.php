...
/**
 * Title: single-oogst
 * Slug: jong-literair-nederland/single-oogst
 * Inserter: no
 */
?>
...
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:group {"align":"wide","backgroundColor":"white","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide has-white-background-color has-background"><!-- wp:jln/jln-titel {"align":"wide"} /-->
...
<!-- wp:column {"width":"25%"} -->
<div class="wp-block-column" style="flex-basis:25%"><!-- wp:query {"queryId":0,"query":{"postType":"post","perPage":10,"pages":1,"order":"desc","orderBy":"date","queryType":"","offset":0,"exclude":[],"inherit":false,"taxQuery":{"include":{"category":[62]}}},"namespace":"ln-query"} -->
